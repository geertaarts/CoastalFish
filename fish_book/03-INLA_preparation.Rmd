...
```{r, eval=T, echo=T}
Xmatrix <- model.matrix(~ water_depth + slib + dz10 + dz60 + depth + tpi_3 + tpi_15 + offset, data=dat.s)
head(Xmatrix)
```
...
# Next to do: Deal with missing values. Make no-data for depth, very shallow, tpi as an average, or just remove all together, or use 
# Look at offset of -Inf
# Deal with no sediment data for Wadden SEa

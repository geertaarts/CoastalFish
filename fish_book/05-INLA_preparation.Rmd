...
```{r, eval=T, echo=T}
Xmatrix <- model.matrix(~ poly(water_depth,4) + poly(slib,4) + poly(dz10,4) + poly(dz60,4) + poly(tpi_3,4) + poly(tpi_15,4) + missing + the.offset, data=dat)
head(Xmatrix)
```

...
- Is there a nice polygon to define study area

- Should we include sediment data from inner-Delta and Wadden Sea? Perhaps use subtidal SIBES?

- what are the other covariates to include? I.e. temperature, salinity, current velocity?

- Include seal predation pressure?

- Divide fishing effort data into beam and pulse?

- How important is it to have a one overarching model, using data from all years?

- What is the research question to answer?

- Use ERSEM model predictions (Johan van der Molen)?
